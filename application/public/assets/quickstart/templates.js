var data_templates = {
    ...
    designs: [
...

		{
		    ...
		    'html': `
			<div class="is-section is-box is-section-100 type-poppins is-dark-text">
...
`
		},
		{
			...
			<div class="is-section is-section-100 type-poppins">
				<div class="is-boxes">
					<div class="is-box is-content-bottom is-box-6">
							...
							<div class="is-box-centered is-content-bottom edge-y-3">
								<div class="is-container v2 is-content-left size-16 leading-12 is-content-800 edge-x-2">
									...
									<div class="row">
										...
										<div class="column half" style="width: 45.7245%; flex: 0 0 auto;">
											<div class="spacer height-20"></div>
										</div>
									</div>
									<div class="row">
					...
					<div class="is-box is-dark-text is-box-6">
						<div class="is-overlay">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-marta-milczarek-751.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered">
...
`
				...
				<div class="is-box-centered">
					<div class="is-container v2 is-content-1400 is-content-left edge-x-2 size-19 leading-14">
						<div class="row clearfix">
							<div class="flex justify-center flex-col items-start column third" style="width: 100%;">
								<div class="spacer height-40"></div>
							...
							<div class="flex justify-center flex-col items-start column third" style="width: 14.1765%; flex: 0 0 auto;">
								<div class="spacer height-80"></div>
							</div>
		
							<div style="width: 49.6374%; flex: 0 0 auto; min-height: 730.47px;" class="column third flex flex-col justify-center items-center">
								<div class="is-dock" style="margin:50px 0">
									<div style="width: 140%;left: 3%;top: -3%;">
										<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-01.png" style="width: 100%; transition: all 0.3s ease-out 0s; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(130px);" data-center-top="transform:translateX(0px);" data-filename="sample-01.png">
									</div>
									<div style="width: 137%;left: 31%;top: 26%;">
										<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-02.png" style="width: 100%; transition: all 0.3s ease-out 0s; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(100px);" data-center-top="transform:translateX(0px);" data-filename="sample-02.png">
									</div>
								</div>
							</div>
						</div>
...

		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-montserrat-roboto">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/invictus-tailoring-sneaker-socks-unsplash.jpg&quot;);">
						<div class="is-overlay-color opacity-0"></div>
					</div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-left edge-x-2 is-content-1200 size-19 leading-14">
							<div class="row clearfix">
								<div style="width: 47.546%; flex: 0 0 auto; min-height: 952.019px;" class="flex flex-col justify-center items-center column half">
									<div class="is-dock" style="margin:50px 0">
										<div style="width: 59%;left: 0%;top: -10%;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/05-iphone.png" style="width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(-100px);" data-center="transform:translateX(0px);">
										</div>
										<div style="width: 59%;left: 24%;top: -0%;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/03-iphone.png" style="width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(100px);" data-center="transform:translateX(0px);">
			
										</div>
									</div>
								</div>
								<div class="flex justify-center flex-col items-start column fourth" style="width: 7.1319%; flex: 0 0 auto;">
									<div class="spacer height-80"></div>
								</div>
								<div class="flex justify-center flex-col items-start column fourth" style="width: 42.638%; flex: 0 0 auto;">
...
`
					...
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1400 is-content-left edge-x-2 size-19 leading-14">
							<div class="row clearfix">
								...
								<div style="width: 67.2596%; flex: 0 0 auto; min-height: 730.47px;" class="column third flex flex-col justify-center items-center">
									<div class="is-dock" style="margin:50px 0">
										<div style="width: 100%;left: 40%;top: 14%;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-03.png" style="width: 100%; transition: all 0.3s ease-out 0s; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(130px);" data-center-top="transform:translateX(0px);" data-filename="sample-03.png">
										</div>
										<div style="width: 71%;left: 3%;top: 49%;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-04.png" style="width: 100%; transition: all 0.3s ease-out 0s; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(100px);" data-center-top="transform:translateX(0px);" data-filename="sample-04.png">
										</div>
										<div style="width: 71%;left: 87%;top: 49%;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-05.png" style="width: 100%; transition: all 0.3s ease-out 0s; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(150px);" data-center-top="transform:translateX(0px);" data-filename="sample-05.png">
										</div>
									</div>
								</div>
							</div>
...

		{
			...
			<div class="is-section is-box is-content-bottom is-dark-text box-autofit type-raleway-lato is-section-100">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/henry-co-unsplash.jpg&quot;);"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-content-bottom edge-y-1">
						<div class="is-container is-content-none size-19 leading-16 v2" style="margin-bottom: 0px; padding-bottom: 0px;">
							...
							<div class="row">
								<div class="column third" style="width: 24.6962%; flex: 0 0 auto;">
									<div class="spacer height-80"></div>
								</div>
								...
								<div class="column third" style="width: 26.2518%; flex: 0 0 auto;">
									<div class="spacer height-80"></div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row clearfix" style="padding-bottom:0;">
								<div class="flex flex-col justify-end items-center column full" style="min-height: 439.533px;">
									<div class="is-dock" style="padding-bottom: 150px;width: 100% !important;">
										<div style="z-index: 100;width: 35%;left: -12%;bottom: 0px;min-width: 262px;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-01.png" style="box-shadow: rgba(22, 22, 22, 0.1) 0.43em 0em 2em; width: 100%; margin: 0px; float: left; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(50px);" data--50-bottom="transform:translateX(0px);" data-filename="design-150a.png">
										</div>
										<div style="z-index: 70;width: 27%;left: 17%;bottom: 0px;min-width: 213px;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-02.png" style="box-shadow: rgba(22, 22, 22, 0.1) 0.43em 0em 2em; width: 100%; margin: 0px; float: left; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(-90px);" data--50-bottom="transform:translateX(0px);" data-filename="design-150b.png">
										</div>
										<div style="z-index: 50;width: 23%;left: 37%;bottom: 0px;min-width: 139px;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-06.png" style="box-shadow: rgba(22, 22, 22, 0.1) 0.43em 0em 2em; width: 100%; margin: 0px; float: left; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(60px);" data--50-bottom="transform:translateX(0px);" data-filename="design-147b.png">
										</div>
										<div style="z-index: 20;width: 27%;left: 53%;bottom: 0px;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/sample-07.png" style="box-shadow: rgba(22, 22, 22, 0.1) 0.43em 0em 2em; width: 100%; margin: 0px; float: left; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(-75px);" data--50-bottom="transform:translateX(0px);" data-filename="header-17.png">
										</div>
										<div style="z-index: 0;width: 31%;left: 72%;bottom: 0px;min-width: 257px;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/header-46-4NkcX3.jpg" style="box-shadow: rgba(22, 22, 22, 0.1) 0.43em 0em 2em; width: 100%; margin: 0px; float: left; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px);" data-bottom-top="transform:translateX(50px);" data--50-bottom="transform:translateX(0px);">
										</div>
									</div>
								</div>
							</div>
...

		{
			...
			<div class="is-section is-section-100 is-box type-opensans is-dark-text">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/federica-galli-unsplash.jpg&quot;);"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-left edge-x-2 is-content-1500 size-18 leading-14">
							<div class="row clearfix">
								<div class="flex justify-center flex-col items-start column third" style="width: 36.3075%; flex: 0 0 auto;">
									...
									<h1 class="size-68 leading-12" style="letter-spacing: 5px;"><span class="font-semibold size-68">Simple.&nbsp;<br></span><span class="size-68 font-light">Adjustable.<br></span><span class="font-semibold size-68">Beautiful.</span></h1>
								...
								<div style="width: 100%;" class="flex flex-col justify-center items-center column third">
									<div class="is-dock">
										<div style="width: 43%;left: -13%;top: 28%;transform: rotateX(10deg) rotateZ(-30deg);">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/02-iphone.png" style="width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(1e-05px, 0px, 1e-05px);" data-bottom-top="transform:translateY(200px);" data-center-top="transform:translateY(0px);" data-filename="02-iphone.png">
										</div>
										<div style="width: 43%;left: 25%;top: -5%;transform: rotateX(10deg) rotateZ(-30deg);">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/03-iphone.png" style="width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(1e-05px, 0px, 1e-05px);" data-bottom-top="transform:translateY(150px);" data-center="transform:translateY(0px);" data-filename="03-iphone.png">
										</div>
										<div style="width: 43%;left: 75%;top: -18%;transform: rotateX(10deg) rotateZ(-30deg);">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/05-iphone.png" style="width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(1e-05px, 0px, 1e-05px);" data-bottom-top="transform:translateY(250px);" data-center="transform:translateY(0px);" data-filename="05-iphone.png">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="is-container v2 is-content-900 size-18 leading-14">
							<div class="row clearfix">
								<div class="column half flex flex-col justify-center items-start" style="min-height: 594.13px;">
									...
									<h1 class="size-68 leading-12" style="letter-spacing: 5px;"><span class="font-semibold size-68">New&nbsp;<br></span><span class="size-68 font-light">Summer<br></span><span class="font-semibold size-68">Trends</span></h1>
									<p>Lorem Ipsum is simply dummy text of the printing industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
									<div class="button-group">
		...
		},
		{
		    ...
		    'contentClass': 'type-raleway-lato',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-raleway-lato">
				<div class="is-overlay">
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1300 size-19 leading-14">
							<div class="row clearfix">
								...
								<div style="width: 54.5004%; flex: 0 0 auto;" class="flex flex-col justify-center items-center column third">
									<div class="is-dock" style="margin:50px 0">
										<div style="width: 42%;left: 12%;top: 7%;transform: rotateX(10deg) rotateZ(-30deg);">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/05-iphone.png" style="width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(1e-05px, 0px, 1e-05px);" data-400-bottom="transform:translateY(100px);" data-bottom="transform:translateY(0px);">
										</div>
										<div style="width: 42%;left: 43%;top: 3%;">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/03-iphone.png" style="width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(1e-05px, 0px, 1e-05px);" data-bottom-top="transform:translateY(150px);" data-center-top="transform:translateY(0px);">
										</div>
									</div>
									<div class="spacer height-40"></div>
								</div>
		...
		
		{
			...
			<div class="is-section is-section-100 type-spacemono">
				<div class="is-boxes">
					...
					<div class="is-box is-box-6 is-content-top is-light-text">
						<div class="is-overlay">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_6NYVPE6NEB-6.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
...

		{
		    ...
		    'html': `
			<div class="is-section is-box is-section-100 type-lato">
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1700 size-18 leading-15">
							<div class="row">
								<div class="column half flex flex-col justify-center items-start">
									<h1 class="leading-12 uppercase size-100">We not only design things. We <span class="font-semibold size-100">design dreams.</span></h1>
									<div class="spacer height-60"></div>
									<div class="button-group">
								...
								<div class="column half flex flex-col justify-center items-center"><img src="[%IMAGE_PATH%]images/01-iphone.png" alt="" data-filename="01-iphone.png"></div>
							</div>
		...
		
		{
			...
			<div class="is-section is-box is-section-100 is-light-text type-poppins">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_GHIBZPY4FS.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
...

		{
			...
			<div class="is-section is-box is-section-100 is-light-text type-poppins-lekton is-content-bottom">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/lesya-vasileva-lCYfAJPp61o-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)" data-y="-2" data-x="0" data-scale="322.60493728952883">
					...
					<div class="is-box-centered is-content-bottom edge-y-4">
						<div class="is-container v2 is-content-1740 size-17 leading-none" style="transition: all 0.3s ease-out 0s;">
							...
							<div class="row">
								...
								<div style="width: 82.2762%; flex: 0 0 auto;" class="column half">
									<div class="spacer height-40"></div>
								</div>
							</div>
							<div class="row">
		...
		
		{
			...
			<div class="is-section is-section-100 type-oswald-opensans">
				<div class="is-boxes">
					<div class="is-box is-box-7 is-dark-text">
						<div class="is-overlay" style="background-color: rgb(255, 255, 255); filter: grayscale(1);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/abbs-johnson-8GZfC8_eRK0-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
								<div class="is-overlay-color opacity-0"></div>
							</div>
						</div>
						<div class="is-boxes">
					...
					<div class="is-box is-box-5 is-light-text is-align-center">
						<div class="is-overlay" style="filter: grayscale(1);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/ali-choubin-Jo63jdL8-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered">
		...
		
		{
			...
			<div class="is-section is-section-100 type-inconsolata">
				<div class="is-boxes">
					<div class="is-box is-box-8 is-content-bottom">
						<div class="is-overlay" style="background-color: rgb(255, 255, 255);">
						</div>
						<div class="is-boxes">
							<div class="is-box-centered is-content-bottom edge-y-2">
								<div class="is-container v2 is-content-1140 leading-none size-16">
									...
									<div class="row">
										<div class="column third" style="width: 56.6157%; flex: 0 0 auto;"><img src="[%IMAGE_PATH%]images/trail-duqHJKl0dBA-unsplash-editVpA34wK.jpg" alt="" data-filename="trail-duqHJKl0dBA-unsplash-editVpA34wK.jpg"></div>
										<div class="column third" style="width: 100%;">
											<div class="spacer height-40"></div>
										</div>
					...
					<div class="is-box is-dark-text is-box-4">
						<div class="is-overlay">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/camilo-contreras-MxD60O3ZzLY-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered is-opacity-90">
		...
		
		{
			...
			<div class="is-section is-box is-section-100 is-light-text type-raleway-lato">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-karolina-grabowska-4207790-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
						<div class="is-overlay-color opacity-10" style="background-color: rgb(0, 0, 0);"></div>
					</div>
				</div>
				<div class="is-boxes">
		...
		
		{
			...
			<div class="is-section is-section-100 is-box type-oranienbaum-sourcesanspro is-dark-text">
				<div class="is-overlay" style="background-color: rgb(224 224 226);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/henry-co-unsplash.jpg&quot;);">
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-left edge-x-2 is-content-1500 size-18 leading-12">
							<div class="row clearfix">
								<div style="width: 42.987%; flex: 0 0 auto;" class="column fourth flex flex-col justify-center items-start">
									<div class="is-dock">
										<div style="width: 53%;left: 30%;top: 0%;transform: rotateX(-10deg) rotateZ(30deg);">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/screen-shot-1-vK0M52.jpg" style="box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em; width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px) rotate(0deg);" data-bottom-top="transform:translateX(-100px) rotate(-20deg);" data-center="transform:translateX(0px) rotate(0deg);">
										</div>
										<div style="width: 53%;left: -5%;top: 0%;transform: rotateX(-10deg) rotateZ(30deg);">
											<img alt="" data-noresize src="[%IMAGE_PATH%]images/06-eu3rD1.jpg" style="box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em; width: 100%; transition: all 0.3s ease-out 0s; transform: translate3d(0px, 1e-05px, 1e-05px) rotate(0deg);" data-400-bottom="transform:translateX(-100px) rotate(-20deg);" data-center="transform:translateX(0px) rotate(0deg);">
										</div>
									</div>
								</div>
								<div class="flex justify-center flex-col items-start column half" style="width: 21.5584%; flex: 0 0 auto;">
									<div class="spacer height-80"></div>
								</div>
		...
		
		{
		    ...
		    'html': `
			<div class="is-section is-box is-section-100 is-dark-text is-content-top type-cormorantsc-ibmplexsanscon">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-karolina-grabowska-7185847-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95 is-content-top edge-y-3">
						<div class="is-container v2 is-content-right edge-x-0-5 is-content-1000 size-17 leading-12" style="transition: all 0.3s ease-out 0s;">
							<div class="row clearfix">
		...
		
		{
			...
			<div class="is-section is-section-100 type-spacemono">
				<div class="is-boxes">
					<div class="is-box is-box-6 is-light-text">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/anna-yenina-OrfKO92rf08-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-900 size-16 leading-none">
									<div class="row">
										<div class="column full">
											<h1 class="text-center tracking-tight leading-09 size-120">Mark's Photography</h1>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="is-box is-box-6 is-light-text is-content-bottom">
						<div class="is-overlay">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-pavel-danilyuk-6075143.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
		...
		
		{
			...
			<div class="is-section is-box is-section-100 is-light-text type-montserrat-roboto">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);filter: grayscale(1);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_GHIBZPY4FS-5.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
		...
		
		{
			...
			<div class="is-section is-section-100 type-frankruhllibre-lato">
				<div class="is-boxes">
					<div class="is-box is-box-6 is-light-text">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-anna-shvets-3771691.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-900 size-16 leading-11">
									<div class="row">
										<div class="column full">
											<h1 class="leading-09 size-188">Creative and Inspiring.</h1>
										</div>
									</div>
									<div class="row">
										<div class="column full">
									...
									<div class="row">
										...
										<div class="column half" style="width: 61.5202%; flex: 0 0 auto;">
											<div class="spacer height-40"></div>
										</div>
									</div>
								</div>
		...
		
		{
		    ...
		    'html': `
			<div class="is-section is-box is-section-100 is-light-text is-content-bottom type-fugazone-librefranklin">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/wood-floor-interior-pxhere.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)" data-y="10" data-x="0" data-scale="113.88211872861704">
				...
				<div class="is-boxes">
					<div class="is-box-centered is-content-bottom edge-y-3">
						<div class="is-container v2 is-content-1600 size-16 leading-12" style="transition: all 0.3s ease-out 0s;">
							...
							<div class="row">
								<div class="column half" style="width: 25.3059%; flex: 0 0 auto;">
									<h3 class="size-28">Every Detail Matters</h3>
									<p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
										when an unknown printer took a galley of type .</p>
								</div>
								<div class="column half" style="width: 74.4366%; flex: 0 0 auto;">
									<div class="spacer height-40"></div>
								</div>
							</div>
							<div class="row">
		...
		
		{
		    ...
		    'contentClass': 'type-oranienbaum-sourcesanspro',
		    'html': `
			<div class="is-section is-box is-section-100 is-dark-text is-content-top type-oranienbaum-sourcesanspro">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/oktavisual-project-zj58Y4J9YDo-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
						<div class="is-overlay-color opacity-0"></div>
					</div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-content-top edge-y-3">
						<div class="is-container v2 is-content-1800 size-16 leading-none" style="transition: all 0.3s ease-out 0s;">
							<div class="row">
								<div class="column full text-center">
							...
							<div class="row">
								<div class="column half" style="width: 77.3066%; flex: 0 0 auto;">
									<div class="spacer height-20"></div>
								</div>
								<div class="column half" style="width: 100%;">
		...
		
		{
			...
			<div class="is-section is-section-100 is-box is-light-text type-heebo-ibmplexmono">
			<div class="is-overlay">
				<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-vlada-karpovich-4050418-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1.05);" data-top-bottom="transform:translateY(70px) scale(1.05)">
		...
		<div class="is-boxes">
			...
			<div class="is-box is-dark-text is-box-7">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
...
`
			...
			<div class="is-boxes">
					...
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-1000 size-16 leading-14">
								...
								<div class="row clearfix">
									<div style="width: 39.4572%; flex: 0 0 auto;" class="column third flex flex-col justify-end items-start">
				...
				<div class="is-box is-box-5">
					<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
						...
						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-marina-podrez-11674118.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
					</div>
				</div>
			</div>
		</div>
		...
		
		{
			...
			<div class="is-section is-section-100 type-montserrat-roboto">
				<div class="is-boxes">
					...
					<div class="is-box is-dark-text is-box-6 is-content-bottom">
						<div class="is-overlay"></div>
						<div class="is-boxes">
							<div class="is-box-centered is-content-bottom edge-y-1">
...

		{
			...
			<div class="is-boxes">
				<div class="is-box is-content-top is-box-5">
					<div class="is-overlay" style="background-color: rgb(247, 247, 247);">

						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-anna-shvets-5614280.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
					</div>
				</div>
				<div class="is-box is-dark-text is-box-7 is-content-bottom">
					<div class="is-overlay"></div>
					<div class="is-boxes">
						<div class="is-box-centered is-content-bottom edge-y-2">
							<div class="is-container v2 is-content-800 size-16 leading-12">
								...
								<div class="row clearfix">
									<div style="width: 41.4209%; flex: 0 0 auto;" class="column half">
									...
									<div style="width: 100%;" class="column half flex flex-col justify-end items-end">
...

		{
			...
			<div class="is-section is-section-100 type-novamono-robotomono">
				<div class="is-boxes">
					...
					<div class="is-box is-box-5">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-ksenia-chernaya-11592925.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
				</div>
			</div>
...

		{
			...
			<div class="is-section is-section-100 type-ibmplexmono">
				<div class="is-boxes">
					<div class="is-box is-dark-text is-box-7 is-align-justify">
						<div class="is-overlay"></div>
						<div class="is-boxes">
							<div class="is-box-centered">
					...
					<div class="is-box is-box-5">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-felipe-cespedes-3029699.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
								<div class="is-overlay-color opacity-0"></div>
							</div>
						</div>
					</div>
...

		{
			...
			<div class="is-section is-section-100 box-space type-quicksand-kalam">
				<div class="is-boxes">
					<div class="is-box is-box-6 is-light-text is-content-bottom">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-george-milton-7034389.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
					...
					<div class="is-box is-dark-text is-box-6 is-content-bottom is-align-justify">
						<div class="is-overlay"></div>
						<div class="is-boxes">
							<div class="is-box-centered is-content-bottom edge-y-1">
...

		{
			...
			<div class="is-section is-section-100 type-cutivemono-lato">
				<div class="is-boxes">
					<div class="is-box is-content-top is-box-5">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-helena-ije-2867899.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
					<div class="is-box is-dark-text is-box-7">
						<div class="is-overlay"></div>
			...
			<div class="is-section is-section-100 type-poppins">
				<div class="is-boxes">
					<div class="is-box is-box-6">
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-920 size-16 leading-12">
									<div class="row">
										<div class="column full"><img src="[%IMAGE_PATH%]images/pexels-karolina-grabowska-4397898-editCzF75BK.jpg" alt=""></div>
									</div>
									<div class="row">
										<div class="column half">
									...
									<div class="row">
										...
										<div class="column half" style="width: 42.5754%; flex: 0 0 auto;">
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
												Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
												when an unknown printer took a galley of type.</p>
										</div>
...

		{
		    ...
		    'contentClass': 'type-raleway-lato',
		    'html': `
			<div class="is-section is-section-100 is-box type-raleway-lato">
				<div class="is-overlay" style="background-color: rgb(255, 255, 255);"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1600 leading-12 size-18">
							<div class="row">
								...
								<div style="width: 100%;" class="column third"><img src="[%IMAGE_PATH%]images/pexels-anna-nekrashevich-7214824-editVSSlbDI.jpg" alt=""></div>
								<div class="column third" style="width: 100%;"><img src="[%IMAGE_PATH%]images/pexels-karolina-grabowska-4041420-edityotf1bZ.jpg" alt=""></div>
							</div>
							<div class="row">
								<div class="column full">
									<div class="spacer height-60"></div>
			...
			<div class="is-section is-section-100 type-alegreya-lato">
				<div class="is-boxes">
					<div class="is-box is-box-7">
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-970 leading-12 size-17">
									<div class="row">
										<div class="column full">
					...
					<div class="is-box is-dark-text is-box-5">
						<div class="is-overlay"></div>
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-600">
									<div class="row">
										<div class="column full"><img src="[%IMAGE_PATH%]images/pexels-lisa-fotios-2362875.jpg" alt=""></div>
									</div>
								</div>
							</div>
						</div>
...

		{
			...
			<div class="is-section is-section-100 type-montserrat-roboto">
				<div class="is-boxes">
					<div class="is-box is-box-5 is-light-text">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/table-boat-chair-floor-seat-glass-pxhere-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)" data-y="-22"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered">
...

		{
			...
			<div class="is-section is-section-100 type-sixcaps-robotomono">
				<div class="is-boxes">
					<div class="is-box is-content-top is-box-5">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-karolina-grabowska-4711892-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
					<div class="is-box is-dark-text is-box-7 is-align-center">
						<div class="is-overlay"></div>
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 h-full flex flex-col justify-between is-content-760 size-16 leading-12">
									...
									<div class="row">
										<div class="column full pb-16" style="min-height: 340px;">
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
												Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
												when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
											<p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1760 leading-12 size-17">
							...
							<div class="row">
								<div class="column fourth p-6"><img src="[%IMAGE_PATH%]images/pexels-ds-stories-8099373-editsdplLyX.jpg" alt=""></div>
								<div class="column fourth flex flex-col justify-start items-start p-6" style="min-height: 847.109px;">
									<div class="spacer height-20"></div>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
										Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
										when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
								...
								<div class="column fourth flex flex-col justify-end items-start p-6"><img src="[%IMAGE_PATH%]images/pexels-anna-nekrashevich-7214824-editNHVQWR3.jpg" alt=""></div>
								<div class="column fourth p-6"><img src="[%IMAGE_PATH%]images/pexels-liza-summer-6347892.jpg" alt="">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
										Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
										when an unknown printer took a galley of type.</p>
								</div>
			...
			<div class="is-section is-section-100 type-nothingyouc-ibmplexmono">
				<div class="is-boxes">
					<div class="is-box is-dark-text is-box-8">
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-left edge-x-2 h-full flex flex-col justify-between is-content-1060 size-16 leading-12">
									<div class="row">
										<div class="column full pt-16">
									...
									<div class="row">
										<div class="pb-16 column half" style="width: 41.9729%; flex: 0 0 auto;">
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
												Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
												when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
										...
										<div class="pb-16 column half" style="width: 100%;">
											<div class="spacer height-40"></div>
										</div>
									</div>
								</div>
					...
					<div class="is-box is-box-4">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-karolina-grabowska-4041420.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
				</div>
			</div>
...

		{
			...
			<div class="is-section is-section-100 type-yantramanav-ibmplexserif">
				<div class="is-boxes">
					...
					<div class="is-box is-box-4">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-samson-katt-5256712.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
				</div>
			</div>
...

		{
			...
			<div class="is-section is-section-100 type-spacemono">
				<div class="is-boxes">
					...
					<div class="is-box is-box-5">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-adam-dubec-1595483-3.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
				</div>
			</div>
...

		{
			...
			<div class="is-section is-section-100 type-raleway-lato">
				<div class="is-boxes">
					<div class="is-box is-content-top is-box-5">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-anna-nekrashevich-7214824.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)" data-y="4"></div>
						</div>
					</div>
					<div class="is-box is-dark-text is-box-7">
						<div class="is-overlay"></div>
...

		{
			...
			<div class="is-boxes">
				<div class="is-box is-content-top is-box-5">
					<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-george-milton-7034061.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
					</div>
				</div>
				<div class="is-box is-dark-text is-box-7">
					<div class="is-overlay"></div>
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-1040 size-16 leading-12">
								...
								<div class="row">
									<div class="column fourth" style="width: 12.5371%; flex: 0 0 auto;">
										<div class="spacer height-20"></div>
									</div>
					...
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-1000 size-17 leading-12">
								...
								<div class="row">
									<div class="column full"><img src="[%IMAGE_PATH%]images/pexels-yuri-manei-2597365-edityb4cTb8.jpg" alt=""></div>
								</div>
							</div>
						</div>
					</div>
...

		{
			...
			<div class="is-boxes">
				...
				<div class="is-box is-box-5">
					<div class="is-overlay" style="filter: grayscale(1);">
						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-yaroslav-shuraev-4937768.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
					</div>
				</div>
			</div>
		</div>
...

		{
			...
			<div class="is-boxes">
				<div class="is-box is-box-5 is-light-text">
					<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-pok-rie-4636769-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
							<div class="is-overlay-color opacity-4" style="background-color: rgb(0, 0, 0);"></div>
						</div>
					</div>
					<div class="is-boxes">
				...
				<div class="is-box is-dark-text is-box-7 is-content-bottom">
					...
					<div class="is-boxes">
						<div class="is-box-centered is-opacity-90 is-content-bottom edge-y-2">
							...
							<div class="row">
								<div class="column third" style="width: 18.262%; flex: 0 0 auto;">
									<div class="spacer height-20"></div>
								</div>
								<div style="width: 100%;" class="column third">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
					...
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-920 leading-12 size-18">
								...
								<div class="row">
									<div style="width: 61.0697%; flex: 0 0 auto;" class="column half"><img src="[%IMAGE_PATH%]images/pexels-karolina-grabowska-7185847-3.jpg" alt=""></div>
					...
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-620">
								<div class="row">
									<div class="column full"><img src="[%IMAGE_PATH%]images/pexels-ivan-samkov-7121803.jpg" alt=""></div>
								</div>
							</div>
						</div>
					</div>
...

		{
			...
			<div class="is-boxes">
				...
				<div class="is-box is-box-5">
					<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-cottonbro-3585034.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
							<div class="is-overlay-color opacity-0"></div>
						</div>
					</div>
				</div>
				...
				<div class="is-box-centered">
					<div class="is-container is-content-1400 v2 size-19 leading-12">
						...
						<div class="row clearfix">
							...
							<div class="column third" style="min-height: 557.517px;">
...

		{
		    ...
		    'contentClass': 'type-opensans',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text is-align-center type-opensans">
				<div class="is-overlay" style="background-color: rgb(255, 255, 255);"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
...
`
...

		{
		    ...
		    'contentClass': 'type-poppins',
		    'html': `
			<div class="is-section is-section-100 is-box is-align-left type-poppins">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 size-16 leading-13 is-content-1100">
...
`
...

		{
		    ...
		    'contentClass': 'type-opensans',
		    'html': `
			<div class="is-section is-section-100 is-box type-opensans is-align-center">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
...

		{
		    ...
		    'contentCss': 'type-opensans.css',
		    'contentClass': 'type-opensans',
		    'html': `<div class="is-section is-section-100 is-box type-opensans">
			<div class="is-overlay"></div>
			<div class="is-boxes">
				<div class="is-box-centered">
...

		{
		    ...
		    'contentClass': 'type-opensans',
		    'html': `
			<div class="is-section is-section-100 is-box type-opensans is-align-left">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
...

		{
		    ...
		    'contentClass': 'type-opensans',
		    'html': `
			<div class="is-section is-section-100 is-box type-opensans is-align-justify">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 size-16 leading-13 is-content-1600">
							<div class="row clearfix">
								<div class="column fourth flex flex-col justify-end items-start" style="min-height: 807.942px;">
								...
								<div class="column fourth flex flex-col justify-end items-start">
									<h3 class="font-light size-48 leading-none">01</h3><img src="[%IMAGE_PATH%]images/pexels-kulbir-10837921.jpg" alt="">
									<p style="color: rgb(72, 72, 72);">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
										when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
								</div>
								<div class="flex flex-col justify-end items-start column fourth">
									<h3 class="font-light size-48 leading-none">02</h3><img src="[%IMAGE_PATH%]images/sarah-dorweiler-9Z1KRIfpBTM-unsplash.jpg" alt="">
									<p style="color: rgb(72, 72, 72);">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
										when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
								</div>
								<div class="flex flex-col justify-start items-start column fourth">
									<h3 class="font-light size-48 leading-none">03</h3><img src="[%IMAGE_PATH%]images/larisa-birta-YP42NILq7qFo-unsplash.jpg" alt="">
									<p style="color: rgb(72, 72, 72);">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
										when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
								</div>
							</div>
					...
					<div class="is-container is-content-1200 v2 leading-14 size-17">
						...
						<div class="row clearfix">
							<div class="column third center">
								<div class="img-circular" style="margin:25px 0;width:240px;height:240px"><img style="height: 100%; width: 100%; object-fit: cover" src="[%IMAGE_PATH%]images/matese-fields-pvHma684eEI-unsplash-editPLXOkUx.jpeg" alt=""></div>
							...
							<div class="column third center">
								<div class="img-circular" style="margin:25px 0;width:240px;height:240px"><img style="height: 100%; width: 100%; object-fit: cover" src="[%IMAGE_PATH%]images/beach-sea-coast-sand-ocean-girl-pxhere-3-editWGbuhNq.jpeg" alt=""></div>
								<h3 class="size-21">Freja E. Andersen</h3>
								<p style="color: rgb(145, 145, 145);" class="uppercase size-16 tracking-wide">Web Developer</p>
							</div>
							<div class="column third center">
								<div class="img-circular" style="margin:25px 0;width:240px;height:240px"><img style="height: 100%; width: 100%; object-fit: cover" src="[%IMAGE_PATH%]images/StockSnap_0XZGV7R94F-editwKNjiBl.jpeg" alt=""></div>
		...
		
		{
		    ...
		    'contentClass': 'type-poppins-lekton',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-poppins-lekton">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
...

		{
		    ...
		    'contentClass': 'type-oranienbaum-sourcesanspro',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-oranienbaum-sourcesanspro">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container is-content-1300 v2 leading-14 size-18">
							...
							<div class="row clearfix">
								...
								<div class="column fourth center flex flex-col justify-start items-center">
									<div class="img-circular" style="margin:25px 0;width:240px;height:240px"><img style="height: 100%; width: 100%; object-fit: cover" src="[%IMAGE_PATH%]images/yoann-boyer-276971-S8TZu2.jpg" alt=""></div>
								...
								<div class="column fourth center flex flex-col justify-start items-center">
									<div class="img-circular" style="margin:25px 0;width:240px;height:240px"><img style="height: 100%; width: 100%; object-fit: cover" src="[%IMAGE_PATH%]images/pablo-hermoso-429590-(1)-fP4pI3.jpg" alt=""></div>
					...
					<div class="is-container v2 size-16 leading-13 is-content-1000">
						...
						<div class="row">
							...
							<div class="text-right column third" style="width: 100%;">
								<div class="img-circular" style="margin:25px 0;width: 13vw;height: 13vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="[%IMAGE_PATH%]images/pexels-anna-baranova-5853496.jpg" alt="" data-filename="pexels-anna-baranova-5853496.jpg"></div>
							</div>
						</div>
						<div class="row">
							<div class="column third text-left" style="width: 100%;">
								<div class="img-circular" style="margin:25px 0;width: 13vw;height: 13vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="[%IMAGE_PATH%]images/luke-southern-9yCYGgPe5Kg-unsplash.jpg" alt="" data-filename="pexels-anna-baranova-5853496.jpg"></div>
							</div>
							<div class="column two-third flex flex-col justify-center items-start" style="width: 47.1816%; flex: 0 0 auto;">
...
`
					...
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-700">
								<div class="row">
									<div class="column full"><img src="[%IMAGE_PATH%]images/drew-colins-Zq7c-TTjhYk-unsplash-editAgbgjIk.jpg" alt="" data-filename="pexels-anete-lusina-4792329-editUY0y6BT.jpg"></div>
								</div>
							</div>
						</div>
					</div>
...

		{
		    ...
		    'contentClass': 'type-heebo-ibmplexmono',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-heebo-ibmplexmono">
				<div class="is-overlay">
...

		{
			...
			<div class="is-section is-section-100 type-poppins">
				<div class="is-boxes">
					<div class="is-box is-dark-text is-align-left is-box-7">
						<div class="is-overlay" style="background-color: rgb(255, 255, 255);"></div>
						<div class="is-boxes">
							<div class="is-box-centered">
					...
					<div class="is-box-img is-box is-box-5">
						<div class="is-overlay">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/frank-flores-BAf3g-id7P4-unsplash-editHCGGfSS.jpg&quot;);"></div>
						</div>
					</div>
				</div>
			</div>
		...
		
		{
		    ...
		    'contentClass': 'type-opensans',
		    'html': `
			<div class="is-section is-section-100 type-opensans is-box is-dark-text">
				<div class="is-overlay">
			
					<div class="is-overlay-color" style="/* background-color: rgb(0, 0, 0); */"></div>
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/XlMxJ222525.jpg&quot;); background-position: 50% 100%; transition: all 0.3s ease-out 0s;"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95">
						<div class="is-container is-content-left is-content-1400 v2 size-16 leading-14">
							<div class="row clearfix">
								<div class="column full center">
							...
							<div class="row clearfix">
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/pexels-koolshooters-97941563.jpg" alt=""></div>
								...
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/eli-defaria-qKXnwCIaULI-unsplash.jpg" alt=""></div>
								<div class="flex flex-col justify-center items-start column fourth">
...
`
					...
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-900 size-16 leading-12">
								<div class="row">
									<div class="column full"><img src="[%IMAGE_PATH%]images/mahabis-footwear-eYE5Sj-eDsE-unsplash-editbSkDWOp.jpg" alt="" data-filename="mahabis-footwear-eYE5Sj-eDsE-unsplash-editbSkDWOp.jpg"></div>
								</div>
								<div class="row">
									<div class="column full">
										<div class="spacer height-40"></div>
...

		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box type-rufina-oxygen">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1580 leading-12 size-18">
							...
							<div class="row">
								<div class="column third p-5"><img src="[%IMAGE_PATH%]images/pexels-marta-milczarek-751.jpg" alt="" data-filename="pexels-marta-milczarek-751.jpg"></div>
								<div class="column third flex flex-col justify-start items-start p-5">
									<div class="spacer height-20"></div>
								...
								<div class="column third p-5"><img src="[%IMAGE_PATH%]images/cat-han-URiyR9qtgs-unsplash2.jpg" alt="" data-filename="cat-han-URiyR9qtgs-unsplash2.jpg">
									<div class="spacer height-40"></div>
									<h3 class="size-19">Product Name</h3>
...

		{
			...
			<div class="is-section is-section-100 type-spacemono">
				<div class="is-boxes">
					...
					<div class="is-box is-box-4">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/annie-spratt-JOSiIdfOJJM-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
				</div>
			</div>
...

		{
		    ...
		    'contentClass': 'type-ibmplexmono',
		    'html': `
			<div class="is-section is-section-100 is-box type-ibmplexmono">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/milad-fakurian-UqP7U400AZs-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1560 size-16 leading-12">
							...
							<div class="row">
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/maeva-vigier-xhz2E1kFzoA-unsplash2-editigQ0QZu.jpg" alt="">
									<h3 class="size-24">Product Name</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
									<div class="spacer height-20"></div>
									<p class="font-semibold size-15"><a href="#" title="">View Details</a></p>
								</div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/elena-putina-7b9BA_BFgcM-unsplash-editrR6SUYa.jpg" alt="">
									<h3 class="size-24">Product Name</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
									<div class="spacer height-20"></div>
									<p class="font-semibold size-15"><a href="#" title="">View Details</a></p>
								</div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/veronika-jorjobert-lbgBjjDy-unsplash2-editqvErgdC.jpg" alt="">
									<h3 class="size-24">Product Name</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
									<div class="spacer height-20"></div>
									<p class="font-semibold size-15"><a href="#" title="">View Details</a></p>
								</div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/priyanka-aggarwal-aJo-DwVB-Xw-unsplash2-edityQWdQej.jpg" alt="">
									<h3 class="size-24">Product Name</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
									<div class="spacer height-20"></div>
									<p class="font-semibold size-15"><a href="#" title="">View Details</a></p>
...

		{
		    ...
		    'contentClass': 'type-alegreya-lato',
		    'html': `
			<div class="is-section is-box type-alegreya-lato is-section-25">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95">
			...
			<div class="is-section box-space type-alegreya-lato is-section-75">
				<div class="is-boxes">
					<div class="is-box-4 is-box is-light-text is-content-top">
						<div class="is-overlay" style="background-color: rgb(243, 243, 243);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/jade-seok-nUJnYJUdexU-unsplash.jpg&quot;);"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered is-content-top edge-y-2">
					...
					<div class="is-box-4 is-box is-dark-text is-content-bottom">
						<div class="is-overlay" style="background-color: rgb(250, 250, 250);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/alen-kajtezovic-d5aIpA4k-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
						<div class="is-boxes">
					...
					<div class="is-box-4 is-box is-light-text is-content-bottom">
						<div class="is-overlay">
			
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/jefferson-sees-fzllIWN_Ldo-unsplash.jpg&quot;);"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered is-content-bottom edge-y-1">
...

		{
			...
			<div class="is-section is-section-100 type-poppins-lekton">
				<div class="is-boxes">
					<div class="is-box is-box-6 is-light-text">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/marissa-grootes-N9uOrBICcjY-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
								<div class="is-overlay-color opacity-4" style="background-color: rgb(0, 0, 0);"></div>
							</div>
						</div>
						<div class="is-boxes">
...

		{
		    ...
		    'contentClass': 'type-oswald-opensans',
		    'html': `
			<div class="is-section is-section-100 is-box type-oswald-opensans">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
...

		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box type-dosis-oldstandardtt is-content-bottom">
				<div class="is-overlay" style="filter: grayscale(1);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/evie-s-uuCjYxJVf4o-unsplash2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-content-bottom edge-y-3">
...

		{
		    ...
		    'contentClass': 'type-oranienbaum-sourcesanspro',
		    'html': `
			<div class="is-section is-section-100 is-box type-oranienbaum-sourcesanspro is-content-top">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/flipboard-HejPSp2evf4-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
...

		{
			...
			<div class="is-section is-section-100 type-poppins" style="background-color: rgb(247, 247, 247);">
				<div class="is-boxes">
					...
					<div class="is-box is-content-bottom is-box-11">
						<div class="is-overlay">
						</div>
						<div class="is-boxes">
							<div class="is-box-centered is-content-bottom edge-y-4">
					...
					<div class="is-box is-dark-text is-box-7">
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-600 size-18 leading-14">
									<div class="row">
										<div class="column full">
											<img src="[%IMAGE_PATH%]images/panos-teloniatis-unsplash.jpg" alt="" data-filename="panos-teloniatis-unsplash.jpg">
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.&nbsp;</p>
										</div>
									</div>
								</div>
...

		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-raleway-playfairdisplay">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/sincerely-media-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
					<div class="is-overlay-color opacity-0"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95">
...

		{
		    ...
		    'contentClass': 'type-yantramanav-ibmplexserif',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-yantramanav-ibmplexserif">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
					...
					<div class="is-boxes">
						<div class="is-box-centered">
							<div class="is-container v2 is-content-700">
								...
								<div class="row">
									<div class="column full"><img src="[%IMAGE_PATH%]images/jodie-cook-CNz0BPaOgy0-unsplash.jpg" alt="" data-filename="jodie-cook-CNz0BPaOgy0-unsplash.jpg"></div>
								</div>
							</div>
						</div>
					</div>
		...
		
		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-juliussansone-robotocondensed">
		...
		
		{
		    ...
		    'contentClass': 'type-dosis-oldstandardtt',
		    'html': `
			<div class="is-section is-box is-section-100 type-dosis-oldstandardtt">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
		...
		
		{
		    ...
		    'contentClass': 'type-lato',
		    'html': `
			<div class="is-section is-section-100 is-box type-lato">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1580 leading-12 size-18">
		...
		
		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-ubuntumono-sourcecodepro">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
		...
		
		{
			...
			<div class="is-section is-section-100 type-montserrat-roboto">
				<div class="is-boxes">
					<div class="is-box is-box-6 is-light-text">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_GHIBZPY4FS-3.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
							<div class="is-overlay-color opacity-8" style="background-color: rgb(0, 0, 0);"></div>
							</div>
						</div>
						<div class="is-boxes">
		...
		
		{
		    ...
		    'contentClass': 'type-rufina-oxygen',
		    'html': `
			<div class="is-section is-section-100 is-box type-rufina-oxygen is-light-text">
				<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/marissa-grootes-2dwLej6Zlfs-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
						<div class="is-overlay-color opacity-6"></div>
					</div>
				</div>
				<div class="is-boxes">
							...
							<div class="row clearfix">
								<div class="column third p-7 flex flex-col justify-center items-center">
									<div style="padding: 50px 20px;width: 100%;box-sizing: border-box;border: #555 1px solid;" class="text-left flex justify-center flex-col items-center">
										...
										<div class="spacer height-20"></div>
										<div class="button-group">
											<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid tracking-75 uppercase py-2 border-current text-black hover:border-current font-normal leading-relaxed ml-0 mr-1 mt-2 mb-2 rounded-full px-11 size-13" onmouseover="if(this.getAttribute('data-hover-bg'))this.style.backgroundColor=this.getAttribute('data-hover-bg');" onmouseout="if(this.getAttribute('data-bg'))this.style.backgroundColor=this.getAttribute('data-bg');else this.style.backgroundColor=''" title="">Buy Now</a>
										</div>
									</div>
								</div>
								<div class="column third p-7 flex flex-col justify-center items-center">
								...
								<div class="column third">
									<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">
										<div style="padding: 30px; width: 100%; box-sizing: border-box;" class="text-center">
											...
											<div class="spacer height-40"></div>
											<div class="button-group">
												<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid tracking-75 uppercase py-2 size-14 px-8 border-current text-black hover:border-current font-normal leading-relaxed rounded-none ml-0 mr-1 mt-2 mb-2" onmouseover="if(this.getAttribute('data-hover-bg'))this.style.backgroundColor=this.getAttribute('data-hover-bg');" onmouseout="if(this.getAttribute('data-bg'))this.style.backgroundColor=this.getAttribute('data-bg');else this.style.backgroundColor=''" title="">Buy Now</a>
											</div>
										</div>
									</div>
								</div>
...

		{
			...
			'contentClass': 'type-oswald-opensans',
			'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-oswald-opensans">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_UB2UXMASS-3.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95">
...

		{
			...
			<div class="is-boxes">
				<div class="is-box-centered">
					<div class="is-container v2 is-content-1400 size-16 leading-12">
						<div class="row clearfix">
							<div class="column full center">
							...
							<div class="column third flex flex-col justify-center items-center">
								<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">
									<div style="padding: 40px 25px; width: 100%; box-sizing: border-box;" class="text-left flex justify-center flex-col items-center">
										...
										<div class="spacer height-20"></div>
										<div class="button-group">
											<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid tracking-75 py-2 size-14 px-8 border-current text-black hover:border-current font-normal leading-relaxed rounded-none ml-0 mr-1 mt-2 mb-2" onmouseover="if(this.getAttribute('data-hover-bg'))this.style.backgroundColor=this.getAttribute('data-hover-bg');" onmouseout="if(this.getAttribute('data-bg'))this.style.backgroundColor=this.getAttribute('data-bg');else this.style.backgroundColor=''" title="">Select Plan</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="is-boxes">
				<div class="is-box-centered">
					<div class="is-container v2 size-16 leading-13 is-content-1200">
						...
						<div class="row clearfix">
							<div class="column third p-8 flex flex-col justify-center items-center" style="width: 100%;">
							...
							<div class="column third p-8 flex flex-col justify-center items-center" style="width: 35.175%; flex: 0 0 auto;">
...

		{
			...
			<div class="is-section is-section-100 is-box is-dark-text type-poppins">
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1500 size-16 leading-14">
							<div class="row clearfix">
								<div class="column full center">
						...
						<div class="is-container v2 leading-12 size-17 is-content-1380">
							...
							<div class="row clearfix">
								<div class="column third pr-9">
									...
									<div class="spacer height-20"></div>
									<div class="button-group">
										<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid tracking-75 uppercase py-2 px-8 border-current text-black hover:border-current font-normal leading-relaxed ml-0 mr-1 mt-2 mb-2 rounded-full size-13" onmouseover="if(this.getAttribute('data-hover-bg'))this.style.backgroundColor=this.getAttribute('data-hover-bg');" onmouseout="if(this.getAttribute('data-bg'))this.style.backgroundColor=this.getAttribute('data-bg');else this.style.backgroundColor=''" title="">Buy Now</a>
									</div>
								</div>
								<div class="column third pr-9">
...

		{
			...
			'contentClass': 'type-poppins',
			'html': `
			<div class="is-section is-section-100 is-box type-poppins is-dark-text">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/ashley-byrd-wDmu7qqY22-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1500 size-16 leading-14">
...

		{
			...
			'contentClass': 'type-oranienbaum-sourcesanspro',
			'html': `
			<div class="is-section is-section-100 is-box type-oranienbaum-sourcesanspro is-light-text">
				<div class="is-overlay" style="background-color: rgb(255, 255, 255);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_RKQU798YK0.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
						<div class="is-overlay-color opacity-10" style="background-color: rgb(0, 0, 0);"></div>
					</div>
				</div>
				<div class="is-boxes">
						...
						<div class="is-container v2 is-content-1200 size-17 leading-14">
							...
							<div class="row clearfix">
								<div class="column third pr-9">
									...
									<div class="spacer height-40"></div>
									<div>
										<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid tracking-75 font-normal uppercase border-current hover:border-current leading-relaxed ml-0 mr-1 rounded-none mt-2 mb-2 size-14 py-2 px-8" onmouseover="if(this.getAttribute('data-hover-bg'))this.style.backgroundColor=this.getAttribute('data-hover-bg');" onmouseout="if(this.getAttribute('data-bg'))this.style.backgroundColor=this.getAttribute('data-bg');else this.style.backgroundColor=''" title="" data-bg="" style="color: rgb(255, 255, 255);">Get Started</a>
									</div>
								</div>
								<div class="column third pr-9">
									...
									<div class="spacer height-40"></div>
									<div>
										<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid tracking-75 font-normal uppercase border-current hover:border-current leading-relaxed ml-0 mr-1 rounded-none mt-2 mb-2 size-14 py-2 px-8" onmouseover="if(this.getAttribute('data-hover-bg'))this.style.backgroundColor=this.getAttribute('data-hover-bg');" onmouseout="if(this.getAttribute('data-bg'))this.style.backgroundColor=this.getAttribute('data-bg');else this.style.backgroundColor=''" title="" style="color: rgb(255, 255, 255);">Get Started</a>
									</div>
								</div>
								<div class="column third pr-9">
...

		{
			...
			<div class="is-section is-section-100 type-lato">
				<div class="is-boxes">
					<div class="is-box-8 is-box is-dark-text">
						<div class="is-overlay" style="background-color: rgb(255, 255, 255);"></div>
						<div class="is-boxes">
							<div class="is-box-centered">
					...
					<div class="is-box-4 is-box-img is-box">
						<div class="is-overlay">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_6NYVPE6NEB-4.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
				</div>
			</div>
...

		{
			...
			<div class="is-section is-section-100 type-ubuntumono-sourcecodepro">
				<div class="is-boxes">
					<div class="is-box-4 is-box-img is-box">
						<div class="is-overlay">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_PJLZHLI1XL.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
					<div class="is-box-8 is-box is-dark-text">
						<div class="is-overlay" style="background-color: rgb(255, 255, 255);">
								...
								<div class="is-container v2 is-content-1100 size-16 leading-12">
									...
									<div class="row clearfix">
										<div class="column third pr-8">
											...
											<div class="spacer height-40"></div>
											<div>
												<a href="#" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid text-black tracking-75 font-normal uppercase border-current hover:border-current leading-relaxed ml-0 mr-1 rounded-none mt-2 mb-2 size-14 py-2 px-8" onmouseover="if(this.getAttribute('data-hover-bg'))this.style.backgroundColor=this.getAttribute('data-hover-bg');" onmouseout="if(this.getAttribute('data-bg'))this.style.backgroundColor=this.getAttribute('data-bg');else this.style.backgroundColor=''">Buy Now</a>
											</div>
										</div>
										<div class="column third pr-8">
...

		{
			...
			'contentClass': 'type-cormorantsc-ibmplexsanscon',
			'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-cormorantsc-ibmplexsanscon">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_TQ30QBDKB-3.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95">
						<div class="is-container is-content-1500 v2 size-19 leading-14">
							<div class="row">
								<div class="column full">
...

		{
			...
			'contentClass': 'type-raleway-lato',
			'html': `
			<div class="is-section is-section-100 is-box type-raleway-lato is-dark-text">
				<div class="is-overlay" style="background-color: rgb(255, 255, 255);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/table-wood-wall-ceiling-shelf-lamp-pxhere-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container is-content-1500 v2 leading-14 size-18">
...
`
...

		{
			...
			<div class="is-boxes">
				...
				<div class="is-box is-box-5 is-light-text is-content-bottom">
					<div class="is-overlay">
						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_GHIBZPY4FS-3.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
							<div class="is-overlay-color opacity-4"></div>
						</div>
		...
		
		{
		    ...
		    'contentClass': 'type-spacemono',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-spacemono">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
...
`
		...
		
		{
			...
			<div class="is-section is-section-100 is-box is-dark-text type-quicksand-kalam">
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1620 size-17 leading-12">
							<div class="row clearfix">
								<div class="column full center">
		...
		
		{
		    ...
		    'contentClass': 'type-raleway-lato',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-raleway-lato is-content-top">
				<div class="is-overlay" style="background-color: rgb(255, 255, 255);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/branch-white-flower-wall-pxhere-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
		...
		
		{
		    ...
		    'contentClass': 'type-alegreya-lato',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-alegreya-lato">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container is-content-1500 v2 leading-14 size-17">
							<div class="row clearfix">
								<div class="column full center">
		...
		
		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-elsie-montserrat">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1100 size-16 leading-14">
		...
		
		{
		    ...
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-oswald-biryani">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
		...
		
		{
			...
			<div class="is-section is-section-100 is-box is-dark-text type-elsie-montserrat">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/ankhurr-chawaak-phXlwhb98jw-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
		...
		
		{
			...
			<div class="is-section is-section-100 type-poppins-lekton">
				<div class="is-boxes">
					<div class="is-box is-content-top is-box-4">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_GHIBZPY4FS-7.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
					</div>
					<div class="is-box is-dark-text is-content-bottom is-box-8">
						<div class="is-overlay"></div>
						<div class="is-boxes">
...
`
...

		{
			...
			<div class="is-section type-alegreya-lato is-section-50">
				<div class="is-boxes">
					...
					<div class="is-box is-box-6">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_6NYVPE6NEB-6.jpg&quot;);"></div>
						</div>
					</div>
				</div>
			</div>
			
			<div class="is-section is-box is-section-50 type-alegreya-lato">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 size-16 leading-12 is-content-1500">
							...
							<div class="row">
								<div style="width: 34.9348%; flex: 0 0 auto;" class="column fourth">
									<div class="spacer height-20"></div>
								</div>
								<div style="width: 100%;" class="column fourth">
									<h3 class="size-54 leading-14">100%</h3>
...

		{
		    ...
		    'html': `
			<div class="is-section is-box is-section-100 is-light-text type-fjallaone-ibmplexserif">
				<div class="is-overlay" style="background-color: rgb(225, 225, 225);">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_GHIBZPY4FS-5.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
				...
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95">
						<div class="is-container v2 size-16 leading-13 is-content-1300">
							...
							<div class="row">
								<div style="width: 29.66%; flex: 0 0 auto;" class="column fifth"><img src="[%IMAGE_PATH%]images/pexels-cottonbro-10120691.jpg" alt="">
								...
								<div style="width: 100%;" class="column fifth"><img src="[%IMAGE_PATH%]images/pexels-elīna-arāja-3317936.jpg" alt="">
								...
								<div style="width: 100%;" class="column fifth flex flex-col justify-end items-end"><img src="[%IMAGE_PATH%]images/pexels-elīna-arāja-3317936.jpg" alt="">
					...
					<div class="is-box-centered">
						<div class="is-container v2 is-content-1400 size-17 leading-13">
							...
							<div class="row">
								...
								<div style="width: 24.0999%; flex: 0 0 auto;" class="column fifth"><img src="[%IMAGE_PATH%]images/oswald-elsaboath-XqBAem99bYM-unsplash-editWD2IShM.jpg" alt="" data-filename="oswald-elsaboath-XqBAem99bYM-unsplash-editWD2IShM.jpg"></div>
								<div style="width: 14.989%; flex: 0 0 auto;" class="column fifth">
									<div class="spacer height-80"></div>
								</div>
								<div class="column fifth" style="width: 28.8758%; flex: 0 0 auto;"><img src="[%IMAGE_PATH%]images/roman-kraft-Q7FTeBhr100-unsplash.jpg" alt="" data-filename="roman-kraft-Q7FTeBhr100-unsplash.jpg"></div>
...
`
...

		{
			...
			<div class="is-boxes">
				<div class="is-box is-box-6 is-light-text">
					<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
						<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/charlesdeluvio-rRWiVQzLm7k-unsplash.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
							<div class="is-overlay-color opacity-0"></div>
						</div>
					</div>
					<div class="is-boxes">
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-1000 size-17 leading-12">
									...
									<div class="row">
										<div class="column two-third"><img src="[%IMAGE_PATH%]images/burst-kUqqaRjJuw0-unsplash.jpg" alt="" data-filename="burst-kUqqaRjJuw0-unsplash.jpg"></div>
										<div class="column third">
											<div class="spacer height-20"></div>
											<p>"Lorem Ipsum is simply dummy text of the printing and typesetting industry.
												Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
							...
							<div class="is-box-centered is-content-bottom edge-y-2">
								<div class="is-container v2 is-content-720 leading-12 size-17">
									...
									<div class="row">
										...
										<div class="column two-third"><img src="[%IMAGE_PATH%]images/pexels-george-milton-7034809-editiqZV3iF.jpg" alt="" data-filename="pexels-george-milton-7034809-editiqZV3iF.jpg"></div>
									</div>
								</div>
							</div>
						</div>
...

		{
		    ...
		    'contentClass': 'type-poppins',
		    'html': `
			<div class="is-section is-section-100 is-box is-light-text type-poppins">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-george-milton-7034800.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)">
						<div class="is-overlay-color opacity-10"></div>
					</div>
				</div>
				<div class="is-boxes">
					...
					<div class="is-box-centered">
						<div class="is-container is-content-1600 v2 size-18 leading-13">
							<div class="row">
								...
								<div class="column half" style="width: 43.3999%; flex: 0 0 auto;"><img src="[%IMAGE_PATH%]images/josh-applegate-bAf3r92aewQ-unsplash-editbN3qLwR.jpg" alt="" data-filename="josh-applegate-bAf3r92aewQ-unsplash-editbN3qLwR.jpg"></div>
							</div>
							<div class="row">
								<div class="column full">
									<div class="spacer height-80"></div>
		...
		
		{
		    ...
		    'contentClass': 'type-rufina-oxygen',
		    'html': `
			<div class="is-section is-section-100 is-box is-dark-text type-rufina-oxygen">
				<div class="is-overlay" style="background-color: rgb(247, 247, 247);"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
							...
							<div class="row clearfix">
								<div class="center column half p-6">
									<div class="is-card is-dark-text" style="width:calc(100%);">
										<img src="[%IMAGE_PATH%]images/sawyer-bengtson-OYpjEN_Tdcs-unsplash.jpg" alt="" style="margin: 0;" data-filename="sawyer-bengtson-OYpjEN_Tdcs-unsplash.jpg">
								...
								<div class="center column half p-6">
									<div class="is-card is-dark-text" style="width:calc(100%);">
										<img src="[%IMAGE_PATH%]images/daniel-mingook-kim-ou1l6VbJTF8-unsplash.jpg" alt="" style="margin: 0;" data-filename="daniel-mingook-kim-ou1l6VbJTF8-unsplash.jpg">
										<div style="padding: 20px; width: 100%; box-sizing: border-box;" class="text-center">
											<i class="icon ion-chatbubble-working size-32"></i>
											<div class="spacer height-20"></div>
											<p>"Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
			...
			<div class="is-boxes">
				<div class="is-box-centered is-opacity-95">
					<div class="is-container v2 size-16 leading-13 is-content-1420">
						...
						<div class="row">
							<div class="column fifth"><img src="[%IMAGE_PATH%]images/creative.png" alt=""></div>
							<div class="column fifth"><img src="[%IMAGE_PATH%]images/steady.png" alt=""></div>
							<div class="column fifth"><img src="[%IMAGE_PATH%]images/light-studio.png" alt=""></div>
							<div class="column fifth"><img src="[%IMAGE_PATH%]images/design-firm.png" alt=""></div>
							<div class="column fifth"><img src="[%IMAGE_PATH%]images/sitepro.png" alt=""></div>
						</div>
					...
					<div class="is-box-centered is-opacity-95">
						<div class="is-container v2 size-16 leading-13 is-content-1420">
							...
							<div class="row">
								...
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/creative.png" alt=""></div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/steady.png" alt=""></div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/light-studio.png" alt=""></div>
							</div>
							<div class="row">
								<div class="column fourth">
									<div class="spacer height-80"></div>
								</div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/infinitech.png" alt=""></div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/design-firm.png" alt=""></div>
								<div class="column fourth"><img src="[%IMAGE_PATH%]images/sitepro.png" alt=""></div>
							</div>
							<div class="row">
								<div class="column full">
									<div class="spacer height-40"></div>
...
`
...

		{
		    ...
		    'contentClass': 'type-poppins',
		    'html': `
			<div class="is-section is-box type-poppins is-section-40">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
				...
				<div class="is-boxes">
						...
						<div class="is-boxes">
							<div class="is-box-centered is-content-bottom edge-y-2">
								<div class="is-container v2 is-content-580">
									<div class="row">
										<div class="column full"><img src="[%IMAGE_PATH%]images/pexels-marina-podrez-11674118-editHV5kzrQ.jpeg" alt=""></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="is-box-4 is-box is-dark-text is-content-top">
						...
						<div class="is-boxes">
							<div class="is-box-centered is-content-top edge-y-2">
								<div class="is-container v2 is-content-620">
									<div class="row">
										<div class="column third"><img src="[%IMAGE_PATH%]images/creative.png" alt=""></div>
										<div class="column third"><img src="[%IMAGE_PATH%]images/steady.png" alt=""></div>
										<div class="column third"><img src="[%IMAGE_PATH%]images/light-studio.png" alt=""></div>
									</div>
									<div class="row">
										<div class="column full">
											<div class="spacer height-40"></div>
									...
									<div class="row">
										...
										<div class="column third"><img src="[%IMAGE_PATH%]images/sitepro.png" alt=""></div>
										<div class="column third"><img src="[%IMAGE_PATH%]images/design-firm.png" alt=""></div>
									</div>
									<div class="row">
										<div style="width: 35.524%; flex: 0 0 auto;" class="column half"><img src="[%IMAGE_PATH%]images/infinitech.png" alt=""></div>
										<div style="width: 100%;" class="column half">
											<div class="spacer height-20"></div>
										</div>
									</div>
					...
					<div class="is-box-4 is-box is-dark-text">
						<div class="is-overlay">
							...
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-maksim-goncharenok-4352247.jpg&quot;);"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered is-opacity-90">
...

		{
			...
			<div class="is-section is-section-100 is-box type-alegreya-lato">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/pexels-anna-nekrashevich-8534168.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
				<div class="is-boxes">
					<div class="is-box-centered">
			...
			<div class="is-boxes">
				<div class="is-box-centered is-opacity-95">
					<div class="is-container v2 size-16 leading-13 is-content-1420">
						...
						<div class="row">
							<div class="flex flex-col justify-center items-center column fifth"><img src="[%IMAGE_PATH%]images/upclick.png" alt=""></div>
							<div class="flex flex-col justify-center items-center column fifth"><img src="[%IMAGE_PATH%]images/digitalmag.png" alt=""></div>
							<div class="flex flex-col justify-center items-center column fifth"><img src="[%IMAGE_PATH%]images/mmedia.png" alt=""></div>
							<div class="flex flex-col justify-center items-center column fifth"><img src="[%IMAGE_PATH%]images/bbuzz.png" alt=""></div>
							<div class="flex flex-col justify-center items-center column fifth"><img src="[%IMAGE_PATH%]images/prosource.png" alt=""></div>
						</div>
						<div class="row">
							<div class="column full">
								<div class="spacer height-60"></div>
				...
				<div class="is-boxes">
					<div class="is-box-centered is-opacity-95">
						<div class="is-container v2 size-16 leading-13 is-content-1420">
							...
							<div class="row">
								<div class="column third"><img src="[%IMAGE_PATH%]images/upclick.png" alt=""></div>
								<div class="column third"><img src="[%IMAGE_PATH%]images/digitalmag.png" alt=""></div>
								<div class="column third"><img src="[%IMAGE_PATH%]images/mmedia.png" alt=""></div>
							</div>
							<div class="row">
								<div class="column third"><img src="[%IMAGE_PATH%]images/prosource.png" alt=""></div>
								<div class="column third"><img src="[%IMAGE_PATH%]images/worldwide.png" alt=""></div>
								<div class="column third"><img src="[%IMAGE_PATH%]images/bbuzz.png" alt=""></div>
							</div>
							<div class="row">
								<div class="column full">
									<div class="spacer height-40"></div>
...
`
...

		{
		    ...
		    'contentClass': 'type-opensans',
		    'html': `
			<div class="is-section is-box box-space type-opensans is-section-70">
				<div class="is-overlay">
					<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_GHIBZPY4FS-4.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
				</div>
			</div>

			<div class="is-section is-box type-oranienbaum-sourcesanspro is-section-30 is-content-top">
				<div class="is-overlay"></div>
				<div class="is-boxes">
					<div class="is-box-centered is-content-top edge-y-1">
						<div class="is-container v2 is-content-1600 is-content-right edge-x-0-5">
							<div class="row">
								...
								<div class="column fifth"><img src="[%IMAGE_PATH%]images/onesight.png" alt=""></div>
								<div class="column fifth"><img src="[%IMAGE_PATH%]images/mmedia.png" alt=""></div>
								<div class="column fifth"><img src="[%IMAGE_PATH%]images/digitalmag.png" alt=""></div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="is-boxes">
							<div class="is-box-centered">
								<div class="is-container v2 is-content-1000">
									...
									<div class="row">
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/upclick.png" alt=""></div>
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/digitalmag.png" alt=""></div>
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/mmedia.png" alt=""></div>
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/bbuzz.png" alt=""></div>
									</div>
									<div class="row">
										<div class="column full">
											<div class="spacer height-40"></div>
									...
									<div class="row">
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/prosource.png" alt=""></div>
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/light-studio.png" alt=""></div>
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/nett.png" alt=""></div>
										<div class="column fourth"><img src="[%IMAGE_PATH%]images/worldwide.png" alt=""></div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container v2 size-17 leading-13 is-content-1700">
							...
							<div class="row">
								<div class="column third flex flex-col justify-end items-start" style="width: 24.7239%; flex: 0 0 auto;"><img src="[%IMAGE_PATH%]images/StockSnap_568E3E34AE-sm.jpg" alt="" data-filename="StockSnap_568E3E34AE-sm.jpg"></div>
								<div class="column third" style="width: 52.456%; flex: 0 0 auto;">
									<div class="spacer height-40"></div>
								</div>
								<div style="width: 100%;" class="column third"><img src="[%IMAGE_PATH%]images/gaelle-marcel-QW9TnaUqGM0-unsplash-editOPbJHFj.jpg" alt="" data-filename="gaelle-marcel-QW9TnaUqGM0-unsplash-editOPbJHFj.jpg"></div>
							</div>
						</div>
					</div>
				</div>
...
`
...

		{
			...
			<div class="is-section is-section-100 type-poppins-lekton">
				<div class="is-boxes">
					<div class="is-box is-light-text is-box-5 is-content-top">
						<div class="is-overlay" style="background-color: rgb(247, 247, 247);">
							<div class="is-overlay-bg" style="background-image: url(&quot;[%IMAGE_PATH%]images/StockSnap_RB5L88OP5Y-2.jpg&quot;);" data-bottom-top="transform:translateY(-70px) scale(1);" data-top-bottom="transform:translateY(50px) scale(1.1)"></div>
						</div>
						<div class="is-boxes">
							<div class="is-box-centered is-content-top edge-y-3">
						...
						<div class="is-boxes">
							<div class="is-box-centered is-opacity-90">
								<div class="is-container v2 size-16 leading-13 is-content-800">
									<div class="row">
										<div class="column full"><img src="[%IMAGE_PATH%]images/pexels-jeffrey-czum-2501968-edittskgiTF.jpeg" alt=""></div>
									</div>
								</div>
							</div>
						</div>
...
`
		},
		{
			...
			<div class="is-section is-section-100 box-space box-space-sm type-poppins">
				<div class="is-boxes">
					<div class="is-box-6 is-box is-light-text is-content-bottom">
						<div class="is-overlay">
...
`
		...
		
		{
		    ...
		    'contentClass': 'type-poppins',
		    'html': `
			<div class="is-section is-box is-dark-text is-static is-section-50 type-poppins">
			<div class="is-overlay"></div>
			<div class="is-boxes">
				<div class="is-box-centered">
						...
						<div class="is-container is-content-1200 v2 size-16 leading-13">
							...
							<div class="row clearfix">
								<div class="column full text-left">
									<p class="size-14 text-center">© Copyright 2022 Company Name</p>
								</div>
							</div>
						</div>
					</div>
...
`
		...
		
		{
		    ...
		    'contentClass': 'type-poppins',
		    'html': `
			<div class="is-section is-box is-dark-text is-static is-section-20 type-poppins">
				<div class="is-overlay" style="background-color: rgb(255, 255, 255);"></div>
				<div class="is-boxes">
					<div class="is-box-centered">
						<div class="is-container is-content-1200 v2 size-16 leading-13">
							<div class="row clearfix">
								...
								<div class="column third center flex justify-center flex-col items-center">
									<p style="line-height: 42px;">© Copyright 2022 Company Name</p>
								</div>
								<div class="column third center flex justify-center flex-col items-center">
									<div class="is-social" style="margin: 25px 0">
										<a href="https://twitter.com/"><i class="icon ion-social-twitter"></i></a>
